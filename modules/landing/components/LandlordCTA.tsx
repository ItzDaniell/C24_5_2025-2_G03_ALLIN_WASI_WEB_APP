...
export function LandlordCTA({ onRegister }: Props) {
  ...
  return (
    <section id="arrendadores" className="py-16 md:py-24 bg-inkwell text-white">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <button
              ...
              className="h-14 px-8 text-lg rounded-md bg-primary hover:bg-primary/90 text-white transition-all hover:shadow-lg hover:scale-105"
            >
