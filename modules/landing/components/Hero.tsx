          ...
          >
            <div className="space-y-4">
              <motion.h1 
                ...
                className="text-4xl sm:text-5xl lg:text-6xl text-[#2D3638] leading-[1.1]"
              >
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-[#2F4F4F] leading-relaxed max-w-xl"
            >
          ...
          >
            <div className="relative aspect-[4/5] max-w-sm mx-auto rounded-3xl overflow-hidden shadow-2xl">
              ...
              <motion.div 
                ...
                className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-xl border border-[#D0D7C8]"
              >
                <div className="flex items-center gap-2">
              ...
              <motion.div 
                ...
                className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-xl border border-[#D0D7C8]"
              >
