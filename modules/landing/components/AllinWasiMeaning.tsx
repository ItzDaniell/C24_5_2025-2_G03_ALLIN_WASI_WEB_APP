    ...
    <section id="allin-wasi" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 relative">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-[#F8FAF9] p-8 rounded-2xl border border-[#D0D7C8]/50 hover:border-[#A37F6E]/30 transition-colors">
        ...
        <div className="relative bg-[#2D3638] rounded-3xl p-8 md:p-12 text-white overflow-hidden shadow-xl">
